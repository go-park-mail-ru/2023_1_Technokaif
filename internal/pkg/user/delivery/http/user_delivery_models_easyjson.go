...
func easyjson40dcd6ddDecodeGithubComGoParkMailRu20231TechnokaifInternalPkgUserDeliveryHttp3(in *jlexer.Lexer, out *UserTransfer) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson40dcd6ddEncodeGithubComGoParkMailRu20231TechnokaifInternalPkgUserDeliveryHttp3(out *jwriter.Writer, in UserTransfer) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v UserTransfer) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson40dcd6ddEncodeGithubComGoParkMailRu20231TechnokaifInternalPkgUserDeliveryHttp3(w, v)
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *UserTransfer) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson40dcd6ddDecodeGithubComGoParkMailRu20231TechnokaifInternalPkgUserDeliveryHttp3(l, v)
}
