...
func easyjson6036cd6fDecodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp2(in *jlexer.Lexer, out *trackFeedInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6036cd6fEncodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp2(out *jwriter.Writer, in trackFeedInput) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v trackFeedInput) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson6036cd6fEncodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp2(w, v)
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *trackFeedInput) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6036cd6fDecodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp2(l, v)
}
func easyjson6036cd6fDecodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp3(in *jlexer.Lexer, out *trackDeleteResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6036cd6fEncodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp3(out *jwriter.Writer, in trackDeleteResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6036cd6fDecodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp4(in *jlexer.Lexer, out *trackCreateResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6036cd6fEncodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp4(out *jwriter.Writer, in trackCreateResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6036cd6fDecodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp5(in *jlexer.Lexer, out *trackCreateInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6036cd6fEncodeGithubComGoParkMailRu20231TechnokaifInternalPkgTrackDeliveryHttp5(out *jwriter.Writer, in trackCreateInput) {
	out.RawByte('{')
	first := true
	_ = first
	{
