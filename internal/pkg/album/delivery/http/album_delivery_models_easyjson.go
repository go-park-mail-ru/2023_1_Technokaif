...
func easyjsonBc29487DecodeGithubComGoParkMailRu20231TechnokaifInternalPkgAlbumDeliveryHttp4(in *jlexer.Lexer, out *AlbumTransfers) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjsonBc29487EncodeGithubComGoParkMailRu20231TechnokaifInternalPkgAlbumDeliveryHttp4(out *jwriter.Writer, in AlbumTransfers) {
...
func easyjsonBc29487DecodeGithubComGoParkMailRu20231TechnokaifInternalPkgAlbumDeliveryHttp5(in *jlexer.Lexer, out *AlbumTransfer) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBc29487EncodeGithubComGoParkMailRu20231TechnokaifInternalPkgAlbumDeliveryHttp5(out *jwriter.Writer, in AlbumTransfer) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v AlbumTransfer) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonBc29487EncodeGithubComGoParkMailRu20231TechnokaifInternalPkgAlbumDeliveryHttp5(w, v)
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *AlbumTransfer) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBc29487DecodeGithubComGoParkMailRu20231TechnokaifInternalPkgAlbumDeliveryHttp5(l, v)
}
